...
public class Main {
    ...
    final static int ORF = 50; //minimun length 50 AAs for a gene
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        String filename;
        if (readingFrame == 1)
            filename = "covidSequenceRF1.csv";
        else if (readingFrame == 2)
            filename = "covidSequenceRF2.csv";
        else
            filename = "covidSequenceRF3.csv";
    ...
    public static void createAAReport(String AAName, PrintWriter outfile) throws FileNotFoundException {
        ...
        if (outfile == null) {
            for (i = 0; i < values.length; i++) {
                ...
                //String output = values[i] + ": " + counters[i] + "\t\t " + String.format("%8.2f", percent) + "% of " + AAName;
            ...
            for (i = 0; i < values.length; i++) {
                double percent = (double) counters[i] / sumAminoAcid * 100;
                //String output = values[i] + ": " + counters[i] + "\t\t " + String.format("%.2f", percent) + "% of " + AAName;
                String output = values[i] + ": " + String.format("%3d%8.2f", counters[i],percent) + "%";
    ...
    public static void geneAnalysis(String filename) throws FileNotFoundException {
        ...
        for (Gene g : genes) {
            outfile.println("Gene " + geneNum + " (" + g.getLength() + ") :\n"
